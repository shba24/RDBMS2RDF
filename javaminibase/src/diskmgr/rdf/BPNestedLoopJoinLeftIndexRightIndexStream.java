...
import iterator.BPLeftIndexRightIndexNestedLoopJoin;
import iterator.BPSort;
import iterator.Iterator;

public class BPNestedLoopJoinLeftIndexRightIndexStream implements IJStream {
  private Iterator iter;

  public BPNestedLoopJoinLeftIndexRightIndexStream(
      JoinQuery joinQuery,
    ...
    BPLeftIndexRightIndexNestedLoopJoin bpLeftScanRightScanJoin = new BPLeftIndexRightIndexNestedLoopJoin(
        joinQuery.getNumBuf(),
        3,
        am1,
        joinQuery.getJnp1(),
    ...
    BPLeftIndexRightIndexNestedLoopJoin bpLeftScanRightScanJoin1 = new BPLeftIndexRightIndexNestedLoopJoin(
        joinQuery.getNumBuf(),
