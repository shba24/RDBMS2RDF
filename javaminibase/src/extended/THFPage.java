...
public class THFPage extends Page 
  ...
  */
  ...
  /**
   * offset of first used byte by data quadruples in data[]
   */
  ...
  /**
   * @return QID of first quadruple on page, null if page contains no quadruples.  
   * @exception  IOException I/O errors
  ...
  public Quadruple getQuadruple ( QID qid ) 
	  ...
	  && (pageNo.pid == curPage.pid))
	{
	  ...
	  aquadruple = new byte[recLen];
	  System.arraycopy(data, offset, aquadruple, 0, recLen);
	  Quadruple quadruple = new Quadruple(aquadruple, 0, recLen);
	  return quadruple;
	}
