...
public class BTIndexPage extends BTSortedPage {
   ...
   *
   * @param qid It will be modified and the first qid in the index page
   ...
   *
   * @param qid It will be modified and next qid will be passed out by itself.
  ...
  boolean redistribute(
      BTIndexPage indexPage, BTIndexPage parentIndexPage,
