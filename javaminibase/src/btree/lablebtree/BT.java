...
public class BT implements GlobalConst {
   ...
   */
  protected final static KeyDataEntry getEntryFromBytes(
      byte[] from, int offset,
  ...
  private static void _printTree(
      PageId currentPageId, String prefix, int i,
      int keyType)
      throws IOException,
      ConstructPageException,
      IteratorException,
