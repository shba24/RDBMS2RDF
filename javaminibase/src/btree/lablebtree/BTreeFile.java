...
public class BTreeFile extends IndexFile
   ...
   * @param lid the lid of the record. Input parameter.
   ...
   * lo_key is null.
   *
   * Starting record returned in *pstartlid, on page *pppage, which is pinned.
   *
  ...
  /*
   *  Status BTreeFile::NaiveDelete (const void *key, const LID lid)
   *
  ...
  /*
   * Status BTreeFile::FullDelete (const void *key, const LID lid)
   *
   * Remove specified data entry (<key, lid>) from an index.
   *
