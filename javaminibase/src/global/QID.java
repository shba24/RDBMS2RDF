...
public class QID implements IQID {
  ...
  /**
   * Copy the state of the specified quadruple ID. The implementation of this function should be the
  ...
  /**
   * Write the quadruple ID into a byte array at the specified offset. The first 4 bytes after the
