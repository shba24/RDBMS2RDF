...
public class Catalog
  ...
  void addIndex(
      String relation, String attrname,
  ...
  // return attrCnt.
  int getRelAttributes(
      String relation, int attrCnt,
      AttrDesc[] attrs)
      throws Catalogmissparam,
      Catalogrelexists,
      Catalogdupattrs,
  ...
  public IndexCatalog getIndCat() {return indCat;}

  public RelCatalog getRelCat() {return relCat;}

  public AttrCatalog getAttrCat() {return attrCat;}
}
