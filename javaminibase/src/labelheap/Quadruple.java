...
public class Quadruple {
  ...
  public Quadruple(byte[] data, int offset, int size) {
  }
   ...
   * @throws IOException
   */
  public IEID getSubjectID() throws heap.FieldNumberOutOfBoundException, IOException {
   ...
   * @throws heap.FieldNumberOutOfBoundException
   */
  public Quadruple setSubjectID(IEID subjectId) throws IOException, heap.FieldNumberOutOfBoundException {
    checkNullObjectAndThrowException();
   ...
   * @throws IOException
   */
  public IPID getPredicateID() throws heap.FieldNumberOutOfBoundException, IOException {
    checkNullObjectAndThrowException();
   ...
   * @throws IOException
   */
  public Quadruple setPredicateID(IPID predicateId) throws heap.FieldNumberOutOfBoundException, IOException {
    checkNullObjectAndThrowException();
   ...
   * @throws IOException
   */
  public IEID getObjectID() throws heap.FieldNumberOutOfBoundException, IOException {
    checkNullObjectAndThrowException();
   ...
   * @throws IOException
   */
  public Quadruple setObjectID(IEID objectId) throws heap.FieldNumberOutOfBoundException, IOException {
    checkNullObjectAndThrowException();
   ...
   * @throws IOException
   */
  public double getConfidence() throws heap.FieldNumberOutOfBoundException, IOException {
    checkNullObjectAndThrowException();
   ...
   * @throws IOException
   */
  public Quadruple setConfidence(double confidence) throws heap.FieldNumberOutOfBoundException, IOException {
    checkNullObjectAndThrowException();
